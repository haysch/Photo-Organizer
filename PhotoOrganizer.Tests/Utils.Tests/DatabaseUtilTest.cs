...
namespace PhotoOrganizer.Tests.Utils.Tests
{
    public class DatabaseUtilTest
    {
        ...
        //[Fact]
        //public void GeneratePostgreSQLConnectionString_Interactive_Trusted()
        //{
        //    var memoryCollection = new Dictionary<string, string>();
        //    var configuration = SetupInMemoryConfiguration(memoryCollection);
        ...
        //    var consoleKeyInput = new List<ConsoleKeyInfo> // Password
        //    {
        //        new ConsoleKeyInfo('y', ConsoleKey.Y, false, false, false),  // Yes to trusted connection
        //    };
        //    var consoleLineInput = new List<string> { host, port.ToString(), database };
        //    var consoleWrapper = new TestConsoleWrapper(consoleKeyInput, consoleLineInput);
        ...
        //[Fact]
        //public void GenerateMySqlConnectionString_Interactive_Trusted()
        //{
        //    var memoryCollection = new Dictionary<string, string>();
        //    var configuration = SetupInMemoryConfiguration(memoryCollection);
        ...
        //        new ConsoleKeyInfo('y', ConsoleKey.Y, false, false, false),  // Yes to trusted connection
        //    };
        //    var consoleLineInput = new List<string> { server, port.ToString(), database };
        //    var consoleWrapper = new TestConsoleWrapper(consoleKeyInput, consoleLineInput);

        //    var npgsqlCsBuilder = new MySqlConnectionStringBuilder
        //    {
        //        Server = server,
        //        Port = (uint)port,
        //        Database = database
        ...
        //    npgsqlCsBuilder.IntegratedSecurity = trusted;
